...
This Go 1.27 application crawls weekly highlights from [Plattentests.de](https://www.plattentests.de), finds the highlighted tracks on Spotify, and builds playlists. A Gin web UI displays current records and search results and can trigger playlist creation.
