...
This repository is a Go 1.27 application that crawls weekly album highlights from [Plattentests.de](https://www.plattentests.de), matches their highlighted tracks on Spotify, and creates playlists. The Gin web UI displays records, supports search, and runs playlist creation.
